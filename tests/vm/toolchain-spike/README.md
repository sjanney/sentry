...
tracepoint attachment through each userspace API. They do not read files, make
network connections, or keep links after the container exits.

Run the arm64 Docker Desktop check from the repository root:
